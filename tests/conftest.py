...
from weather_app.db.utils import create_database, drop_database
from weather_app.services.redis.dependency import get_redis_pool
from weather_app.settings import settings
from weather_app.web.application import get_app
...
async def _engine(anyio_backend: Any) -> AsyncGenerator[AsyncEngine]:
    ...
    :yield: new engine.
    """
    from weather_app.db.meta import meta
    from weather_app.db.models import load_all_models
...
@pytest.fixture
async def test_redis_pool() -> AsyncGenerator[ConnectionPool]:
    """
