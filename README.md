...
All environment variables should start with "WEATHER_APP_" prefix.

For example if you see in your "weather_app/settings.py" a variable named like
`random_parameter`, you should provide the "WEATHER_APP_RANDOM_PARAMETER" 
variable to configure the value. This behaviour can be changed by overriding `env_prefix` property
in `weather_app.settings.Settings.Config`.

An example of .env file:
```bash
WEATHER_APP_RELOAD="True"
WEATHER_APP_PORT="8000"
WEATHER_APP_ENVIRONMENT="dev"
```
